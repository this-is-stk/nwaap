...
echo \<center\>\<img src\=\"https\://www.ericsson.com/4aaaa2/assets/local/digital-services/offerings/network-automation/na-components.png\"\>\</center\> >> /var/www/html/demo.html
